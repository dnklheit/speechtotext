<template>
  <div class="speech_container">
    ...
    <div class="info">
      <p>1). Not eklemek için mikrofona tıklayın ve eklemek istediğiniz notu söyleyin. Program otomatik olarak o notu ekleyecektir ve local storage'a kaydedecektir.</p>
      <p>
        2). Eklediğiniz notu silmek için notun numarasını söyleyin.
        <br />
        Örnek: "1 numaralı notu sil."
        <br />
        <p>3). Tüm notları silmek için aşağıdaki gibi yapın.
            <br/>
              Örnek: "Tüm notları sil."
        </p>
